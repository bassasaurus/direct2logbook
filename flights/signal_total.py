...
#     aircraft = Aircraft.objects.get(user=instance.user, aircraft_type=instance.aircraft_type)
#     aircraft_class =  str(aircraft.aircraft_class)
#     aircraft_category = str(aircraft.aircraft_category)
#
#     cat_class_query = Q(aircraft_type__aircraft_class__aircraft_class__icontains=aircraft_class) & Q(
#         aircraft_type__aircraft_category__aircraft_category__icontains=aircraft_category)
#
#     flight = Flight.objects.filter(user=instance.user).filter(cat_class_query).latest('date')
#     # flight.save()
#
#     total_update(Flight, flight, **kwargs)
