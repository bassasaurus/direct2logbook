...
def pdf_output(objects, user):
    ...
    for page_num in p.page_range:
        ...
        this_page_footer = '<tr><td style="border: 0px" colspan="3">I certify the entries in this logbook to be true.</td>' + make_table_row(this_page_footer) + '</tr>'
