...
def pdf_output():
    ...
    file = open('pdf_output/log_table.html', 'w')
    file.write('')
    file.close()
    ...
    for page_num in p.page_range:
        ...
        for flight in flights:
            ...
            file = open('pdf_output/log_table.html', 'a')

            log_row = (flight.date, flight.route, flight.aircraft_type, flight.registration, flight.duration, row['pilot_in_command'],
